...
pdf("PaperFigures/predictionsARICorBoxplotLRIntOrig.pdf", width=5.25, height=6)
...
pdf("PaperFigures/predictionMetricCorBoxplotLRIntOrig.pdf", width=6.25, height=6.1)
